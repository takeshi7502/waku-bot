...
from waku.webapp.errors import install_error_handlers
from waku.webapp.routers import system
from waku.webapp.static import add_api_security_headers, mount_static
...
def create_app(*, panel_enabled: bool | None = None) -> FastAPI:
    ...
    from waku.webapp.routers import admin, auth, chats, me
