...
result_anan_tips: types.InlineQueryResultArticle = types.InlineQueryResultArticle(
    title="An An nói",
    input_message_content=types.InputTextMessageContent(message_text="Hãy để mình nói gì đó đi~"),
    description="Cách dùng: ms anan [biểu cảm] [nội dung]",
...
result_trial_ema_tips: types.InlineQueryResultAnimation = (
    types.InlineQueryResultAnimation(
        title="Tranh luận - Emma",
        description="Bắt đầu liệt kê lựa chọn",
        animation_url="https://waku.unv.app/assets/manosaba/trial_ema.mp4",
        thumb_url="https://waku.unv.app/assets/manosaba/trial_ema_static.jpg",
        caption="Chọn điểm bạn để ý",
...
result_trial_hiro_tips: types.InlineQueryResultAnimation = (
    types.InlineQueryResultAnimation(
        title="Tranh luận - Hiro",
        description="Cô gái ngụy chứng bí ẩn",
        animation_url="https://waku.unv.app/assets/manosaba/trial_hiro.mp4",
        thumb_url="https://waku.unv.app/assets/manosaba/trial_hiro_static.jpg",
        caption="Bắt đầu ngụy chứng của bạn",
